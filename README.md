...
# 50422wxapp岳阳市美术馆预约平台小程序

![picture](https://raw.githubusercontent.com/GraduationProject-springboot/.github/main/img/wx.png)

### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1NvtMeFEiw?p=82)


# 第1章 绪论
## 1.1 课题背景
互联网发展至今，无论是其理论还是技术都已经成熟，而且它广泛参与在社会中的方方面面。它让信息都可以通过网络传播，搭配信息管理工具可以很好地为人们提供服务。所以各行业，尤其是规模较大的企业和学校等都开始借助互联网和软件工具管理信息，传播信息，共享信息等等，以此可以增强自身实力，提高在同行业当中的竞争能力，并从各种激烈的竞争中获取发展的机会。针对高校教师成果信息管理混乱，出错率高，信息安全性差，劳动强度大，费时费力等问题，经过分析和考虑，在目前的情况下，可以引进一款岳阳市美术馆预约平台这样的现代化管理工具，这个工具就是解决上述问题的最好的解决方案。它不仅可以实时完成信息处理，还缩短高校教师成果信息管理流程，使其系统化和规范化。同时还可以减少工作量，节约高校教师成果信息管理需要的人力和资金。所以岳阳市美术馆预约平台是信息管理环节中不可缺少的工具，它对管理者来说非常重要。
## 1.2 课题意义 
现如今，信息种类变得越来越多，信息的容量也变得越来越大，这就是信息时代的标志。近些年，计算机科学发展得也越来越快，而且软件开发技术也越来越成熟，因此，在生活中的各个领域，只要存在信息管理，几乎都有计算机的影子，可以说很多行业都采用计算机的方式管理信息。信息计算机化处理相比手工操作，有着保密性强，效率高，存储空间大，成本低等诸多优点。针对高校教师成果信息管理，采用岳阳市美术馆预约平台可以有效管理，使信息管理能够更加科学和规范。

总之，在实际中使用岳阳市美术馆预约平台，其意义如下：

第一点：岳阳市美术馆预约平台的实际运用，可以帮助管理人员在短时间内完成信息处理工作；
...
第四点：可以降低信息管理成本；
## 1.3 研究内容
对岳阳市美术馆预约平台设计制作，不仅需要技术支撑，也需要大量的理论研究。本文在对岳阳市美术馆预约平台进行介绍时，将按照如下内容进行。

第一部分：介绍岳阳市美术馆预约平台研究的背景意义，便于用户了解系统；

第二部分：介绍开发岳阳市美术馆预约平台需要搭建的环境，包括技术和工具；

第三部分：介绍用户对岳阳市美术馆预约平台的功能要求，以及对岳阳市美术馆预约平台的性能要求等；
...
# 第2章 开发环境与技术
岳阳市美术馆预约平台的编码实现需要搭建一定的环境和使用相应的技术，接下来的内容就是对岳阳市美术馆预约平台用到的技术和工具进行介绍。
## 2.1 MYSQL数据库
...
### 3.1.2 经济可行性
本系统开发期间需要配置的软件环境，可以免费通过开发类官网下载安装，需要配置的硬件设备也不需要具备很高的性能，通常网吧电脑，或学校计算机机房的电脑都符合要求。因此，从经济方面考虑，岳阳市美术馆预约平台开发可行。
### 3.1.3 操作可行性
岳阳市美术馆预约平台根据用户使用习惯进行开发，设计的界面具有统一性，并具备优秀的导航功能。所以，只要会简单操作电脑的人员，可以无压力操作岳阳市美术馆预约平台。
...
![C:/Users/Administrator/Desktop/temp111\2\\_\_\_\_img\展品收藏.jpg](/md/blog.007.jpeg "C:/Users/Administrator/Desktop/temp111\2\\_\_\_\_img\展品收藏.jpg")
展品收藏实体属性图

（3）下图是操作日志实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\2\\_\_\_\_img\操作日志.jpg](/md/blog.008.jpeg "C:/Users/Administrator/Desktop/temp111\2\\_\_\_\_img\操作日志.jpg")
操作日志实体属性图

（4）下图是参观预约实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\2\\_\_\_\_img\参观预约.jpg](/md/blog.009.jpeg "C:/Users/Administrator/Desktop/temp111\2\\_\_\_\_img\参观预约.jpg")
参观预约实体属性图

（5）下图是美术馆实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\2\\_\_\_\_img\美术馆.jpg](/md/blog.010.jpeg "C:/Users/Administrator/Desktop/temp111\2\\_\_\_\_img\美术馆.jpg")
美术馆实体属性图

（6）下图是论坛实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\2\\_\_\_\_img\论坛.jpg](/md/blog.011.jpeg "C:/Users/Administrator/Desktop/temp111\2\\_\_\_\_img\论坛.jpg")
论坛实体属性图

（7）下图是美术馆收藏实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\2\\_\_\_\_img\美术馆收藏.jpg](/md/blog.012.jpeg "C:/Users/Administrator/Desktop/temp111\2\\_\_\_\_img\美术馆收藏.jpg")
美术馆收藏实体属性图

（8）下图是展品留言实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\2\\_\_\_\_img\展品留言.jpg](/md/blog.013.jpeg "C:/Users/Administrator/Desktop/temp111\2\\_\_\_\_img\展品留言.jpg")
展品留言实体属性图

（9）下图是公告通知实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\2\\_\_\_\_img\公告通知.jpg](/md/blog.014.jpeg "C:/Users/Administrator/Desktop/temp111\2\\_\_\_\_img\公告通知.jpg")
公告通知实体属性图

（10）下图是展品信息实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\2\\_\_\_\_img\展品信息.jpg](/md/blog.015.jpeg "C:/Users/Administrator/Desktop/temp111\2\\_\_\_\_img\展品信息.jpg")
展品信息实体属性图

（11）下图是美术馆留言实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\2\\_\_\_\_img\美术馆留言.jpg](/md/blog.016.jpeg "C:/Users/Administrator/Desktop/temp111\2\\_\_\_\_img\美术馆留言.jpg")
美术馆留言实体属性图
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|meishuguan\_uuid\_number|String|美术馆编号|是|
|3|meishuguan\_name|String|美术馆名称|是|
|4|meishuguan\_photo|String|美术馆照片|是|
|5|meishuguan\_address|String|美术馆地点|是|
|6|zan\_number|Integer|赞|是|
|7|cai\_number|Integer|踩|是|
|8|meishuguan\_types|Integer|美术馆类型|是|
|9|meishuguan\_kucun\_number|Integer|门票数量|是|
|10|meishuguan\_new\_money|BigDecimal|门票价格|是|
|11|meishuguan\_clicknum|Integer|美术馆热度|是|
|12|jieshu\_time|Date|结束时间|是|
|13|meishuguan\_content|String|美术馆介绍|是|
|14|meishuguan\_delete|Integer|逻辑删除|是|
|15|insert\_time|Date|录入时间|是|
|16|create\_time|Date|创建时间     homeMain|是|
表4.5美术馆收藏表

|序号|列名|数据类型|说明|允许空|
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|meishuguan\_id|Integer|美术馆|是|
|3|yonghu\_id|Integer|用户|是|
|4|meishuguan\_collection\_types|Integer|类型|是|
...
|2|meishuguan\_id|Integer|美术馆|是|
|3|yonghu\_id|Integer|用户|是|
|4|meishuguan\_liuyan\_text|String|留言内容|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|meishuguan\_order\_uuid\_number|String|订单编号|是|
|3|meishuguan\_id|Integer|美术馆|是|
|4|yonghu\_id|Integer|用户|是|
|5|buy\_number|Integer|预约人数|是|
|6|meishuguan\_order\_true\_price|BigDecimal|实付价格|是|
|7|meishuguan\_order\_types|Integer|订单类型|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|zhanpin\_name|String|展品名称|是|
|3|zhanpin\_photo|String|展品封面|是|
|4|zhanpin\_video|String|视频|是|
|5|zhanpin\_types|Integer|展品类型|是|
|6|zan\_number|Integer|赞|是|
|7|cai\_number|Integer|踩|是|
|8|meishuguan\_clicknum|Integer|展品热度|是|
|9|zhanpin\_content|String|展品详情|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|zhanpin\_id|Integer|展品|是|
|3|yonghu\_id|Integer|用户|是|
|4|zhanpin\_collection\_types|Integer|类型|是|
|5|insert\_time|Date|收藏时间|是|
|6|create\_time|Date|创建时间|是|
表4.12展品留言表
...
|2|zhanpin\_id|Integer|展品|是|
|3|yonghu\_id|Integer|用户|是|
|4|zhanpin\_liuyan\_text|String|留言内容|是|
|5|insert\_time|Date|留言时间|是|
